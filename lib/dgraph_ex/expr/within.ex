defmodule DgraphEx.Expr.Within do
  ...
  defmacro __using__(_) do
    quote do
      ...
      def within(label, [ [x, y] | _] = geo_json) when is_atom(label) and is_float(x) and is_float(y) do
  ...
  def render(%Within{label: label, geo_json: [ [x, y] | _] = geo_json }) when is_atom(label) and is_float(x) and is_float(y) do
